...
<body>
   <header>
    ...
    <section>
      <h2 class="display-4">Dying Light 2</h2>
<img src="grafiki/dl2.jpg" class="rounded float-left"width="200" height="200" >
<form>
...
<ul class="list-group">
  <li class="list-group-item">Kontynuacja nagradzanej gry akcji w świecie postapokaliptycznym.</li>
